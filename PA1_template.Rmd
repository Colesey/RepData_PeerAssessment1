...
The strategy chosen is to fill each missing value with the mean for that time 5-minute time slot. To do this, we will take the activities data frame and replace the NA values with the mean values for the time slot that we have in dailyActivity and create a new data fram called activitiesNoNAs.  
